...
# Read in the data
combined_df <- read_csv("C:/Users/x.ying1/Downloads/merged_csf_cross_sectional_call_rate_pau_data_0205.xls")

pca <- read_csv("C:/Users/x.ying1/Downloads/merged_csf_cross_sectional_call_rate_PCs_0201.csv")
...
filtered_df <- subset(merged_df, Status_at_draw_mapping %in% c("DLB", "AD"))
dim(filtered_df)
...
filtered_df$Status <- ifelse(filtered_df$Status_at_draw_mapping == "AD", 0, 1)
...
write.xlsx(significance_results, "C:/Users/x.ying1/Downloads/CSF_DAA_AD_DLB_2PC_0207.xlsx", rowNames = FALSE)
